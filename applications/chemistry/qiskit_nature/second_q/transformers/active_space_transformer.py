...
class ActiveSpaceTransformer(BaseTransformer):
    ...
    def __init__(
        ...
        self.output_vars = {'electronic_structure': ElectronicStructureProblem}
    ...
    def run(self, electronic_structure: ElectronicStructureProblem):
        """Run the routine
        """
        return self._transform_electronic_structure_problem(electronic_structure)
